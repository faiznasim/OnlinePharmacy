   ...
   <%@ include file="header.jsp" %> 
    ...
    <body>
       ...
       // out.println("driver loaded");
        ...
        ResultSet rs =st.executeQuery("select name ,email from registration where id ="+n);
       // out.println(rs);
        rs.next();
     ...
     padding-top: 20px;">
          ...
          <a href="order.jsp">  <h2 class="heading" style=" margin-left: 100px; padding-top: 10px; background-color:  #08088A; width: 200px;height: 40px; box-shadow: 10px 10px 5px #888888;">Order NOW</h2>
