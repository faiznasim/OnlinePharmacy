 ...
 * @author OOPs
 */
public class Orderyourown extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String s1 = request.getParameter("name");
           ...
           String s3 = request.getParameter("product");
           String s4 = request.getParameter("company");
     ...
     Connection  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/medistore1","root" ,"");
      ...
      Statement  st =  con.createStatement();
        ...
        int rs =  st.executeUpdate("insert into medistore1.suggest(s_name,s_email,m_name,m_company) values ('"+s1+"','"+s2+"','"+s3+"','"+s4+"')");
